...
def main():
    ...
    algorithm = input("Enter algorithm ({q}uicksort, {b}ubblesort, append {p}artial or {r}elational): ")
    N = int(input("Enter N: "))
    ...
    digit_count = lambda n: int(math.log10(n)) + 1
    ...
    for n in range(1, N + 1):
        ...
        for i in range(reps):
            ...
            test = ALGORITHMS[algorithm](n, learner, full_reporting)
            test.run()
