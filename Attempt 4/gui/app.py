...
class SearchApp:
    ...
    def setup_ui(self):
        ...
        style.configure(
            "Section.TLabel", font=("Helvetica", 12, "bold"), background="white"
        )
        ...
        # Header
        header = ttk.Label(
            main_frame, text="Coach-Driven Search", style="Header.TLabel"
        )
        header.grid(row=0, column=0, columnspan=3, pady=(0, 20))

        # Learner's Rule Base Area
        learner_frame = ttk.LabelFrame(
            main_frame, text="Learner's Rule Base", padding="10"
        )
        ...
        self.learner_rules = scrolledtext.ScrolledText(
            learner_frame, height=20, wrap=tk.WORD, font=("Helvetica", 10)
        )
        ...
        search_frame = ttk.LabelFrame(
            main_frame, text="Search Context and Results", padding="10"
        )
        ...
        context_frame = ttk.LabelFrame(
            search_frame, text="Current Context", padding="5"
        )
        context_frame.grid(
        ...
        self.context_text = scrolledtext.ScrolledText(
            context_frame, height=5, wrap=tk.WORD, font=("Helvetica", 10)
        )
        ...
        self.results_text = scrolledtext.ScrolledText(
            results_frame, height=10, wrap=tk.WORD, font=("Helvetica", 10)
        )
        ...
        # Coach's rule base
        coach_rules_frame = ttk.LabelFrame(
            coach_frame, text="Coach's Rule Base", padding="5"
        )
        coach_rules_frame.grid(
        ...
        self.coach_rules = scrolledtext.ScrolledText(
            coach_rules_frame, height=8, wrap=tk.WORD, font=("Helvetica", 10)
        )
        ...
        self.advice_text = scrolledtext.ScrolledText(
            advice_frame, height=8, wrap=tk.WORD, font=("Helvetica", 10)
        )
    ...
    def perform_search(self):
        ...
        self.update_text_widget(
            self.context_text, f"Start State: {query}\nGoal State: {query} (modified)"
        )
