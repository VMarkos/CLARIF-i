...
class SpecificationPanel(tk.LabelFrame):
    ...
    def create_widgets(self):
        ...
        self.state_space_entry = PlaceholderEntry(
            state_frame,
        ...
        self.rules_tree = ttk.Treeview(
            tree_frame, columns=columns, style="Custom.Treeview", show="headings"
        )
        for col in columns:
...
class ReasoningPanel(tk.LabelFrame):
    ...
    def create_widgets(self):
        ...
        self.initial_state_entry = PlaceholderEntry(
            container,
            placeholder="e.g., Color=red; Size=small; Shape=circle",
            width=40,
            justify="left",
        )
        ...
        self.search_button.grid(
            row=0, column=2, rowspan=2, padx=5, pady=2, sticky="nsew"
        )
        ...
        self.target_state_entry = PlaceholderEntry(
            container,
            placeholder="e.g., Size=large (partial allowed)",
            width=40,
            justify="left",
        )
        self.target_state_entry.grid(row=1, column=1, padx=5, pady=2, sticky="ew")

        self.trace_slider = tk.Scale(
            container,
            from_=0,
            to=0,
            orient="horizontal",
        ...
        self.trace_slider.grid(
            row=2, column=0, columnspan=2, padx=5, pady=(5, 2), sticky="ew"
        )
        ...
        self.result_tree = ttk.Treeview(
            result_frame, columns=columns, style="Custom.Treeview", show="headings"
        )
        for col in columns:
