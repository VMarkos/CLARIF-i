\begin{tikzpicture}[
		...
		node/.style={circle, inner sep=0.15cm, outer sep=0.2mm, draw=black, thick},
	...
	% Text boxes
	\node[text box={2}] (proactive) at (-0.8,2.2) {Proactive Coaching};
	\node[text box={2}] (reactive) at (-0.8,-0.9) {Reactive Coaching};
	\node[text box={2}] (reflexive) at (4.2,2.2) {Reflexive Coaching};
