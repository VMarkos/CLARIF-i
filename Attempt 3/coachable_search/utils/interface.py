...
class CoachingInterface:
    ...
    def create_menu_bar(self):
        ...
        file_menu.add_command(
            label="Save Scenario As...", command=self.save_scenario_as
        )
    ...
    def create_main_frames(self):
        ...
        self.continue_button = ttk.Button(
            button_frame, text="Continue", command=self.on_continue
        )
    ...
    def create_table(self, parent, title):
        ...
        # Create treeview
        tree = ttk.Treeview(
            frame, columns=("Name", "Condition", "Action", "Priority"), show="headings"
        )
        ...
        if not self.scenario_manager.current_scenario:
            ...
            try:
                self.scenario_manager.save_scenario(
                    self.scenario_manager.current_scenario, self.current_data
                )
